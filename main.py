...
def draw():
    ...
    #If the play button is clicked
        ...
        if lobby == True:
            ...
            screen.draw.text("PRESS [SPACE] TO START", (370, 250),
                             color=(200, 200, 200),
                             background="black")
            ...
            if h_game_start == True:
                ...
                hunting_bg.draw()
                hunter.draw()
                screen.draw.text("Score: {}".format(hunting_score), (370, 20),
                                 color=(200, 200, 200),
                                 background="black")
        ...
        #If the hunting game ends, the following is executed, essentially the endscreen
            ...
            screen.clear()
            screen.fill('black')
            screen.draw.text("GAME OVER!", (300, 195),
                             color=(200, 200, 200),
                             background="black")
            screen.draw.text("Score: {}".format(hunting_score), (350, 213),
                             color=(200, 200, 200),
                             background="black")
            h_score()
            #If there are no elements in the hunting highscores list (the game has never been played before)
            if len(hunting_highscores) == 0:
                screen.draw.text("Highscore: 0", (325, 235),
                                 color=(200, 200, 200),
                                 background="black")
            else:
                #Displays the currect highscore of the game
                screen.draw.text("Highscore: {}".format(
                    h_score_highscore(hunting_highscores)), (325, 235),
                                 color=(200, 200, 200),
                                 background="black")
        ...
        if water_game == True:
            ...
            screen.draw.text("Score: {}".format(water_score), (725, 10),
                             color=(200, 200, 200),
                             background="black")
            screen.draw.text("Strike in: {}".format(reset_timer), (700, 30),
                             color=(200, 200, 200),
                             background="black")
            screen.draw.text("Time Remaining: {}".format(water_game_time),
                             (618, 50),
                             color=(200, 200, 200),
                             background="black")
            screen.draw.text("Strikes: {}".format(strikes), (725, 70),
                             color=(200, 200, 200),
                             background="black")
            dirty_water.draw()
            ...
            if water_end_screen == True:
                screen.clear()
                screen.fill('grey')
                screen.draw.text("GAME OVER!", (325, 195),
                                 color=(200, 200, 200),
                                 background="black")
                screen.draw.text("Score: {}".format(water_score), (350, 213),
                                 color=(200, 200, 200),
                                 background="black")
                back_bttn.draw()
                ...
                if len(water_highscores) == 0:
                    ...
                    screen.draw.text("Highscore: {}".format(
                        w_score_highscore(water_highscores)), (325, 235),
                                     color=(200, 200, 200),
                                     background="black")
    ...
    if play_clicked == True:
        ...
        if water_game == True:
            ...
            if reset_timer == 240:
                ...
                dirty_water.pos = (random.randint(30, 780),
                                   random.randint(30, 490))
...
def on_mouse_down(pos):
    ...
    if water_game == True:
        ...
        if dirty_water.collidepoint(pos):
            ...
            water_score += 1
            # choose_direction_f = True
            dirty_water.pos = (random.randint(30,
                                              780), random.randint(30, 490))
        else:
...
def h_score():
    ...
    if name_false == True:
        try:
            name = input((
                'Please enter the name you wish to be displayed on the leaderboard: '
            ))
            name_false = False
        except:
            name = input((
